...
const StockPlan:React.FC<TStockPlanProps> = React.forwardRef((props, ref) => {
                ...
                >
                    <Box width='70%' height={'100% !important'}>
                        <Grid container spacing={4}>
                            <Grid item xs={12}>
                                <Details title="Stock Plan" handleChange={DetailsHandleChange} {...DetailsProps} />
                            </Grid>
                            <Grid item xs={12}>
                                <Grid container>
                                    <Container>
